...
# Type: New Service
#
# Title: AD - Disable Computer Account
#
# v 1.0 Initial Release
# v 1.1 Added Stored Credentials
#       see for details: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AD_DisableComputer&utm_content=PS1
...
# Code Template V 1.3
#
# URL: https://au2mator.com/disable-computer-account-active-directory-self-service-with-au2mator/?utm_source=github&utm_medium=social&utm_campaign=AD_DisableComputer&utm_content=PS1
# Github: https://github.com/au2mator/AD-Disable-Computer-Account
#################
...
[string]$LogPath = "C:\_SCOworkingDir\TFS\PS-Services\AD - Disable Computer Account"
[string]$LogfileName = "Disable Computer Account"

[string]$CredentialStorePath = "C:\_SCOworkingDir\TFS\PS-Services\CredentialStore" #see for details: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AD_DisableComputer&utm_content=PS1
...
# Stored Credentials
# See: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AD_DisableComputer&utm_content=PS1
...
Write-au2matorLog -Type INFO -Text "Try to disable AD Computer"

try {
    Disable-ADAccount -Identity $c_Computer -Confirm:$false
    Write-au2matorLog -Type INFO -Text "Computer disabled"

    $au2matorReturn = "Computer $((Get-ADComputer -identity $c_Computer).Name) disabled"
    $AdditionalHTML = "<br>
    Computer $((Get-ADComputer -identity $c_Computer).Name) has been disabled
        <br>
        "
    $Status = "COMPLETED"
}
    ...
    Write-au2matorLog -Type ERROR -Text "Not able to disable Computer"
    Write-au2matorLog -Type ERROR -Text $Error

    $au2matorReturn = "Failed to disable Computer $((Get-ADComputer -identity $c_Computer).Name), Error: $Error"
    $AdditionalHTML = "<br>
    Failed to disable Computer $((Get-ADComputer -identity $c_Computer).Name)
        <br>
        Error: $Error
        "
    $Status = "ERROR"
